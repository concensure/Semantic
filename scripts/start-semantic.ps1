param(
  ...
  [string]$SemanticBaseUrl = "http://127.0.0.1:4317",
  [string]$ApiHealthUrl = "http://127.0.0.1:4317/health",
  [string]$McpHealthUrl = "http://127.0.0.1:4321/health",
  [switch]$StopExisting
)
...
Write-Host ""
Write-Host "URLs"
Write-Host "Semantic UI: http://127.0.0.1:4317/semantic_ui"
Write-Host "API health : $ApiHealthUrl"
Write-Host "MCP root   : http://127.0.0.1:4321/"
Write-Host "MCP tools  : http://127.0.0.1:4321/mcp/tools"
Write-Host ""
